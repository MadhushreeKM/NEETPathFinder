package com.project.neetpathfinder.util;
...
public class EmailUtil {
  ...
  public void sendOtpEmail(String email, String otp) throws MessagingException {
	    ...
	    mimeMessageHelper.setSubject("NeetPathFinder - Verify OTP");
	    
//	    Resource resource = new ClassPathResource("neetpathfinder.png");
//	    mimeMessageHelper.addInline("neetPathFinderLogo", resource);
	    ...
	    String htmlContent = """
	        ...
	        <body>
	            <div class="container">
	                <div class="content">
	                    <p>Dear User,</p>
	                    <p>We have received a request to verify your account on NeetPathFinder. Please use the following OTP:</p>
  ...
  public void sendWelcomeEmail(String email) throws MessagingException {
	    ...
	    mimeMessageHelper.setTo(email);
	    mimeMessageHelper.setFrom(emailUsername);
	    mimeMessageHelper.setSubject("Welcome to NeetPathFinder");
	        ...
	        <body>
	            <div class="container">
	                <div class="content">
	                    ...
	                    <p class="welcome-message">Welcome to NeetPathFinder!</p>
